...
exports.AUTHERRORS = {
    ...
    InvalidTokenFormat: {
        ...
        message: "The token format you have entered is incorrect. Make sure it is Bearer <token>.",
        status: 400,
    },
    MissingData: {
        name: "Missing Data",
    ...
    MissingUser: {
        name: "Missing User",
        message: "The user you have entered is not in our database. Please cross check that your information is correct",
        status: 404,
    },
    InvalidEmail: {
        name: "Invalid Email",
    ...
    PasswordCriteria: {
        ...
        message: "The password must be eight characters long, contain atleast 1 uppercase, lowercase, number and a special character !#?()$%£",
        status: 400,
    },
    IncorrectCode: {
        name: "Incorrect Code",
