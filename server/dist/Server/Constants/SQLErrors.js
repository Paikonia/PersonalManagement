...
exports.SQLERRORS = exports.COMMONERRORS = void 0;
...
exports.SQLERRORS = {
    "3024E": {
        ...
        message: "Write operations that take too long to execute may lead to query timeouts.",
        status: 500,
    },
    "40000": {
        name: "Transaction Rollback",
        message: "Transactions may be rolled back due to various issues, including constraint violations, deadlock resolution, or other errors during write operations.",
        status: 500,
    },
    "22001": {
        name: "Data truncated",
    ...
    "22007": {
        ...
        message: "The date format entered is incorrect. Please check the mysql documentation.",
        status: 400,
    },
    "42000": {
